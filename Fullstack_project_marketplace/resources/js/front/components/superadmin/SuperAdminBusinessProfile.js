...
function SuperAdminBusinessProfile() {
    document.title='Super Admin Business Profile: Market Place';
  return (
    <div>
        ...
        <div id="roles">
            ...
            <div class="dashboard-title">
                <p style={{"textAlign": "center"}}>Business Profile
                    <button class="product-btn"><Link to="/superadmin/businesses">Back to Profiles</Link></button>
                </p>
...
export default SuperAdminBusinessProfile;