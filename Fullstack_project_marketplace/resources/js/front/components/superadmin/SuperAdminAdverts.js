...
function SuperAdminAdverts() {
    document.title='Super Admin Adverts: Market Place';
  return (
    <div>
        <SuperAdminNav setActive='adverts'/>
        <div id="roles">
            <section class="dashboard">
            <div class="dashboard-title">
                <p style={{"textAlign": "center"}}>Business Adverts and Promotions 
                </p>
            </div>
