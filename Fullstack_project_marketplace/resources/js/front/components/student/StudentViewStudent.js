...
function StudentViewStudent() {
    document.title='Student View Student: Market Place';
        ...
        <div id="roles">
            ...
            <div className="dashboard-title">
                <p style={{"textAlign": "center"}}>Viewing Student Profile
                    <button className="product-btn"><Link to="/student/student_profile">Back to Profiles</Link></button>
                </p>
...
export default StudentViewStudent;
