...
function SchoolProfile() {
    document.title='Sch Admin Profile: Market Place';
  return (
    <div>
        <SchoolNav setActive='profile'/>
        <div id="roles">
                        ...
                        <div class="">
                            <div class="services-info-item">
                                ...
                                <div class="product-details">
                                    ...
                                    <div>
                                    <p class="product-description">School Admin Bio and other Information</p>
                                    <p class="product-seller">Email Address</p>
                                    <p class="product-seller">Phone</p>
                                    <p class="product-seller">School</p>
                                    <p>
