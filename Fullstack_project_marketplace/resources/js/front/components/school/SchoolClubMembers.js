...
function SchoolClubMembers() {
    document.title='Sch Admin Club Members: Market Place';
  return (
    <div>
        ...
        <div id="roles">
            ...
            <div class="dashboard-title">
                <p style={{"textAlign": "center"}}>Manage Club 
                    <button class="product-btn"><Link to="/school/view_clubs">Back to Clubs</Link></button>
                </p>
            </div>
...
export default SchoolClubMembers;